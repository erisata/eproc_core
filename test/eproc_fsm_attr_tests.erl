...
event_test() ->
    ...
    meck:expect(Mod, handle_event, fun
        ...
        (#attribute{attr_id = 1}, state, my_event2) -> {trigger, #trigger_spec{type = trg2}, {update, data2, state2}};
        (#attribute{attr_id = 1}, state, my_event3) -> {trigger, #trigger_spec{type = trg3}, {remove, reason3}}
    end),
