...
add_key_test() ->
    ...
    {ok, AttrActions3, _LastAttrId3, State3} = eproc_fsm_attr:transition_end(0, 0, [second], State2),
    {ok, State4} = eproc_fsm_attr:transition_start(0, 0, [second], State3),
    {ok, AttrActions5, _LastAttrId5, _State5} = eproc_fsm_attr:transition_end(0, 0, [third], State4),
    erlang:erase('eproc_fsm$id'),
    DefAction = #attr_action{module = eproc_router, needs_store = true},
    ?assertThat(AttrActions3, contains_member(DefAction#attr_action{attr_id = 1, action = {create, undefined, [second], {data, key1, undefined}}})),
    ?assertThat(AttrActions3, contains_member(DefAction#attr_action{attr_id = 2, action = {create, undefined, [],       {data, key2, undefined}}})),
    ?assertThat(AttrActions3, contains_member(DefAction#attr_action{attr_id = 3, action = {create, undefined, [],       {data, key3, ref3     }}})),
    ?assertThat(AttrActions3, contains_member(DefAction#attr_action{attr_id = 4, action = {create, undefined, [],       {data, key4, undefined}}})),
    ?assertThat(AttrActions3, contains_member(DefAction#attr_action{attr_id = 5, action = {create, undefined, [],       {data, key5, ref5     }}})),
    ?assertThat(AttrActions3, has_length(5)),
    ?assertThat(AttrActions5, contains_member(DefAction#attr_action{attr_id = 1, action = {remove, {scope, [third]}}})),
